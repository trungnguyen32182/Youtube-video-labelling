...
const DisplayInfo = ({ title, isLoading, video, channel, result, component, data }) => {
    return (
        <div className='display-container flex flex-col justify-center items-center w-full h-full'>
            ...
            <div className='mt-5'>
                {isLoading ? (
                    ...
                    <div className="flex flex-col w-full justify-center mt-6  p-4 bg-white/30  ">
                        <p className="ml-12 mt-4 font-bold text-[2.5rem]" >{video?.title}</p>
